...
function Postprofile() {
  ...
  return (
    <div className="w-2/4 mx-auto items-center overflow-hidden space-3  shadow-xl p-2">
      <img
      ...
      ></img>
      <div className=" text-center text-2xl text-cyan-800 mt-3 font-extralight">
        ID: {profile.id}
      </div>
      <div className=" text-center text-2xl text-cyan-800 mt-3 font-extralight">
      ...
      <div className="text-center text-xl text-cyan-800 mb-3 font-extralight ">
        Body: {profile.body}
      </div>
    </div>
  );
